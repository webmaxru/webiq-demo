...
| [deployment.md](./deployment.md) | Azure Container Apps deployment: live environment + resource names, cost model (warm min-replica vs scale-to-zero), Bicep infra, azd env vars, deploy/redeploy/teardown, container build. |
